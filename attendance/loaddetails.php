...
global $mydb;
 ...
 function time_exists($id,$date,$tfield){ 
  ...
  function validate_time_interval($id, $date, $tfield, $time_now) {
    ...
    // Define and initialize $max before using it
    // For example, you might set $max based on some business logic or a query result
    $max = 0; // Set $max to a default value or retrieve it from the database
    ...
    if (!$row) {
        ...
        echo "No records found for the given StudentID and Date.";
