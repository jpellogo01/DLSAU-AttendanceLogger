...
<head>
  ...
  <title>Home | DLSAU Attendance Monitoring System</title>
  <!-- core CSS -->
...
<body id="login">
  ...
  <style type="text/css">
    body {
      background: url(./photo/video-bumper.jpg);
  ...
  <div class="row">
    <h1 align="center">DLSAU Attendance Monitoring System</h1>
  </div>
        ...
        <div class="features">
          ...
          <div class="col-sm-7 wow fadeInDown">
            ...
            <div class="col-md-8">
              ...
              <div id="check_attendance" style="color:#fff; text-align:right;"></div>
  ...
  <h2 style="color:#fff;text-align: left; margin-left:50px; margin-top:290px"><span id="tick2" class="pull-rigth">
